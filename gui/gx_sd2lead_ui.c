...
static void ref_value_changed(GtkAdjustment *adj, gpointer* args) {
    ...
    gx_sd2leadUI* ui = (gx_sd2leadUI*)arg->ui;
    if (ui->block) {
        ui->block = 0;
        return;
    }
...
static LV2UI_Handle instantiate(const LV2UI_Descriptor*   descriptor,
    ...
    *widget = NULL;
    ...
    const char* plug_name = "GxSD2Lead" ;
    ...
    set_expose_func(GX_SD2LEAD_PAINT_BOX(ui->pbox),"pedal_expose");
    ...
    ui->adj[1] = gtk_adjustment_new( -16.0, -2e+01, 4.0, 0.1, 0.1*10.0, 0);
    ...
    ui->adj[2] = gtk_adjustment_new( 4e+02, 1e+02, 1e+03, 1.03, 1.03*10.0, 0);
