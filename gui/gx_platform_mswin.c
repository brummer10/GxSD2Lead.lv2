...
void gx_gui_create_window_and_surface(gx_sd2leadUI *ui) {
	...
	static TCHAR szClassName[] = TEXT("gx_sd2leadUIClass");
	WNDCLASS wndclass = {0};
...
void gx_gui_destroy_main_window(gx_sd2leadUI *ui) {
	...
	UnregisterClass(TEXT("gx_sd2leadUIClass"), NULL);
}
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	gx_sd2leadUI *ui = (gx_sd2leadUI *)GetWindowLongPtr(hwnd, GWLP_USERDATA);
