...
static LV2UI_Handle instantiate(const LV2UI_Descriptor * descriptor,
	...
	ui->controls[0] = (gx_controller) {{ 1.0, 1.0, 0.0, 1.0, 1.0},          { 50, 30, 61, 61}, false,"POWER", BSWITCH, BYPASS};
	ui->controls[1] = (gx_controller) {{ 0.5, 0.5, 0.0, 1.0, 0.01},         { 110, 30, 61, 61}, false,"DRIVE", KNOB, DRIVE};
	ui->controls[2] = (gx_controller) {{ -16.0, -16.0, -20.0, 4.0, 0.5},    { 180, 30, 61, 61}, false,"LEVEL", KNOB, LEVEL};
	ui->controls[3] = (gx_controller) {{ 400.0, 400.0, 100.0, 1000.0, 10.3},{ 250, 30, 61, 61}, false,"TONE", KNOB, TONE};
	ui->block_event = -1;
